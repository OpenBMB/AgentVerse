    ...
    <div class="end-subtask-info">
        <div class="end-subtask-info-content">
            <div class="end-subtask-info-content-item">
                ...
                <json-viewer class="end-subtask-info-content-item-viewer" :value="CommandName" :expand-depth="0"
                    :expanded="false"></json-viewer>
            </div>
            <div class="end-subtask-info-content-item">
                <span class="end-subtask-info-content-item-title">
                    Tool Input:
                </span>
                <json-viewer class="end-subtask-info-content-item-viewer" :expand-depth="0" :expanded="false"
            ...
            <div class="end-subtask-info-content-item">
                ...
                <!-- <span v-if="isString(ExecutionResults)" class="result-viewer-btn-wrapper">
                    <el-button plain size="small" @click="handleViewResult" :icon="View">
                        View Result
                    </el-button>
                </span> -->

                <json-viewer class="end-subtask-info-content-item-viewer" :expand-depth="0" :expanded="false"
                    :value="ExecutionResults"></json-viewer>
            </div>

            <!-- <div class="end-subtask-info-content-item" v-if="isPythonNoteBook">
                <span class="end-subtask-info-content-item-title">
                    Tool Input Code:
                </span>
                <span class="code-viewer-btn-wrapper">
                    <el-button plain size="small" :icon="View" @click="handleViewCode">View code</el-button>
                </span>
            </div> -->
            ...
            <!-- <div class="end-subtask-info-content-item">
                ...
                <span class="command-status-wrapper">
                    ...
                    <span style="padding-top: 8px; margin-left: 5px;" :class="{
            ...
            <!-- <el-dialog v-model="isModalOpen" :title="modalTitle" width="70%" :modal="true" align-center
                :before-close="handleClose" destroy-on-close>
                <code-viewer :value="viewedCodeStr" :isShowLineNum="showLineNum" />
                <template v-slot:footer>
                    <el-button type="primary" @click="isModalOpen = false">Close</el-button>
                </template>
            </el-dialog> -->
        </div>
    </div>
...
.result-viewer-btn-wrapper,
.code-viewer-btn-wrapper {
    height: auto;
    padding-top: 5px;
}
