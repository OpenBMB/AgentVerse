<template>
  <section class="apply flex-row flex-center">
    <div class="form-box flex-row flex-column" :class="{
      active:
        form.corporation &&
        form.email &&
        form.industry &&
      ...
      <div class="form-content flex-column">
        <div class="form-field" data-label="Name" :class="{
            error: form.name === '' && isSubmit,
            focus: focusType === 'name'
          }">
          <el-input v-model="form.name" placeholder="Your name（For review purposes only）" @focus="focusType = 'name'" />
          <p class="form-field-label flex-row flex-center">
            Name
          </p>
        </div>
        <div class="form-field" data-label="Your Company/Collage Name"
          :class="{ error: form.corporation === '' && isSubmit, focus: focusType === 'corporation' }">
          <el-input v-model="form.corporation" @focus="focusType = 'corporation'" />
          <p class="form-field-label flex-row flex-center">Company/Collage Name</p>
        </div>
        <div class="form-field" data-label="Industry"
          :class="{ error: form.industry === '' && isSubmit, focus: focusType === 'industry' }">
          <el-input v-model="form.industry" @focus="focusType = 'industry'" />
          <p class="form-field-label flex-row flex-center">
            Industry
          </p>
        </div>
        <div class="form-field" data-label="Position"
          :class="{ error: form.position === '' && isSubmit, focus: focusType === 'position' }">
          <el-input v-model="form.position" @focus="focusType = 'position'" />
          <p class="form-field-label flex-row flex-center">
            Position
          </p>
        </div>
        ...
        <div class="need-info flex-column">
          ...
          <div class="form-field email" data-label="Company or school email" :class="{
      ...
      <div class="form-footer flex-column">
        <el-button class="submit-btn flex-row flex-center" :disabled="formState.emailState || isSignUpComplete"
          :loading="isSignUpLoading" @click="submit">
          Submit Application
        </el-button>
