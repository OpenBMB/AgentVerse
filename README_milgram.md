...
When running Bash scripts on Windows, you need to use Unix-style path separators ("/") rather than backslashes (""). Try running the script using a Unix-style path:
