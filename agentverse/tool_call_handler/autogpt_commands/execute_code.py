...
def execute_python_file(filename: str, config) -> str:
...
def validate_command(command: str, config) -> bool:
...
def execute_shell(command_line: str, config) -> str:
...
def execute_shell_popen(command_line, config) -> str:
